...
export const BankAccountPaymentStep = ({
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-between grow w-full px-4 py-6 gap-4">
      ...
      {/* Steps section */}
      <div className="flex flex-col w-full gap-3 animate-in slide-in-from-bottom-8 fade-in ease-in-out duration-500">
        {/* Step 1: Account copy */}
        <div className="flex flex-col gap-1">
          ...
          <div className="flex gap-3">
            <div className="flex flex-col items-center w-[18px] shrink-0">
              <div className="w-[2px] flex-1 bg-primary/30 rounded-full" />
            </div>
            <div className="flex-1 flex flex-col gap-1 min-w-0">
              <div className="bg-fill-pink-light flex items-center justify-center px-3.5 py-4 rounded-[9px]">
                <p className="text-base font-medium text-label-alternative whitespace-nowrap">
                  <span
              ...
              <p className="text-xs font-medium text-primary leading-[1.3] text-center">
                계좌를 누르면 자동 복사 됩니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 flex flex-col gap-1 min-w-0">
              <div className="bg-fill-pink-light flex items-center justify-center px-3.5 py-4 rounded-[9px]">
                <span
                  className={cn(
                    "text-base font-medium text-label-alternative",
              ...
              <p className="text-xs font-medium text-primary leading-[1.3] text-center">
                꼭! 아래 숫자를 '받는 분 통장 표시'에 입력해야 자동 충전돼요
              </p>
            </div>
          </div>
        </div>
